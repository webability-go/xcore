...
func TestLanguageParam(t *testing.T) {
  ...
  data["#"], _ = xcore.NewXLanguageFromString("some=a tiny table\nlanguages=of english language\n")
...
`)
  ...
  data := xcore.NewXDataset()
  data["data1"] = "DATA1"
  data["data2"] = "DATA1"
  sm := xcore.NewXDataset()
  sm["data31"] = "DATA31"
  data["data3"] = sm
  data["data4"] = 123
  data["data5"] = 123.432
